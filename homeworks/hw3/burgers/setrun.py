...
#------------------------------
    ...
    probdata.add_param('q1',   -1.0,  'qinit value for x<0')
    probdata.add_param('q2',    2.0,  'qinit value for x>0')
    probdata.add_param('efix',  True,  'use entropy fix?')
    ...
    clawdata.lower[0] = -2.000000e+00          # xlower
